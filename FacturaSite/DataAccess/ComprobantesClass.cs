...
namespace FacturaSite.DataAccess
{
    public class ComprobantesClass
    {
        ...
        /// </summary>
        /// <returns> Comprobantes </returns>
        public List<Comprobantes> ComprobantesSinEvidencia(AdsertiSqlDataAccess adsertiDataAccess)
        {
            ...
            try
            {
                ...
                sentenciaSql.Append("	(SELECT  ");
                sentenciaSql.Append("			ComprobanteId ");
                sentenciaSql.Append("		FROM ");
                sentenciaSql.Append("			Comprobantes ");
                sentenciaSql.Append("	EXCEPT ");
                sentenciaSql.Append("	SELECT  ");
                sentenciaSql.Append("			ComprobanteId  ");
                sentenciaSql.Append("		FROM  ");
